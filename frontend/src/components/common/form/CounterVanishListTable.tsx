...
export const CounterVanishListTable: FC<IVanishTableProps> = ({
  listItems,
  handleBookingSeat,
  couponInputs,
  handleCouponChange,
  ...
  return (
    <section className="h-full w-full overflow-x-auto">
      <table className="table-auto w-full border-collapse border border-gray-300">
        <thead>
          <tr className="bg-gray-100 dark:bg-[#1f2128] border border-gray-300 text-sm">
            ...
            {permission?.showDiscountMenu === true && isDiscountActive ? (
              <>
                <th className="border border-gray-300 px-2">
              ...
              <td className="border border-gray-300 px-2 text-center">
                <AlertDialog>
                  <AlertDialogTrigger asChild>
                    <Button
                      className="w-5 h-[20px] p-0 m-0 mt-1"
                      size="icon"
                      variant="destructive"
                    >
