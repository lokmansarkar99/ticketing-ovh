...
interface ICallcenterDashboardSidebarSmallDevicesProps {}

const CallcenterDashboardSidebarSmallDevices: FC<
  ICallcenterDashboardSidebarSmallDevicesProps
> = () => {
...
export default CallcenterDashboardSidebarSmallDevices;
