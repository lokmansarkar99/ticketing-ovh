...
import { IMigrateSearch } from "./MigrateSeat";
import formatter from "@/utils/helpers/formatter";

interface SearchMigrateSeatFormProps {
  title: string;
...
export default SearchMigrateSeatForm;