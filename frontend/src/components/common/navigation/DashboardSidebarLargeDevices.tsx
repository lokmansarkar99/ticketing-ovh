...
> = () => {
  ...
  return (
    <aside
      className={cn(
        "fixed h-[100vh] overflow-auto border border-yellow-500 scrollbar-hide inset-y-0 left-0 z-10 hidden lg:flex flex-col m-1.5 bg-muted/30 backdrop-blur-sm rounded-md  transition-all duration-300",
    ...
    >
      ...
      >
        ...
        {/* user information */}
        <div
          className="flex gap-2 items-center border-2 px-2 rounded-xl border-primary/50 border-dashed bg-primary/5 backdrop-blur-[2px]"
        >
