...
const UpperSupervisorDashboardSidebarLargeDevice = () => {
    ...
    <div className="bg-[#425e66]">
      <div className="flex justify-between items-center w-full py-1.5 px-6 gap-1 bg-[#666e73] max-h-[40px]">
        <div className="flex items-center">
          {supervisorNavigationLinks.map((item) => (
            <div
              key={item.key}
              className="relative"
...
export default UpperSupervisorDashboardSidebarLargeDevice;