...
interface ISubAdminDashboardSidebarLargeDevicesProps {}

const SubAdminDashboardSidebarLargeDevices: FC<
  ISubAdminDashboardSidebarLargeDevicesProps
> = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* user information */}
        {subAdminNavigationLinks?.length > 0 &&
...
export default SubAdminDashboardSidebarLargeDevices;
