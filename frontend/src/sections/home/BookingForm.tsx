  ...
  const handleBookingSeat = (seatData: any) => {
    setBookingFormState((prevState) => {
      ...
      if (isSeatAlreadySelected) {
        ...
        if (bookingFormState?.selectedSeats?.length >= 6) {
        ...
        // Special logic for S_Class coaches (split fares)
          ...
          <PageTransition className="lg:col-span-8 col-span-12 flex flex-col justify-between h-full w-full">
            ...
            <div className="lg:mt-2 mt-1">
              ...
              {paymentType === "PARTIAL" && (
                <div className="flex justify-center text-center mt-4">
                  <Paragraph variant="destructive" size="sm">
                    {translate(
                      `যাত্রীকে অবশ্যই প্রস্থানের সময় কমপক্ষে ${partialData.data.time} আগে বকেয়া অর্থ প্রদান করতে হবে। অন্যথায় আপনার টিকিট বাতিল বলে বিবেচিত হবে।`,
                      `The passenger must pay the due amount at least ${partialData.data.time} before the departure time. Otherwise, your ticket will be considered canceled.`
                    )}
                  </Paragraph>
                </div>
              )}
            ...
            <div className="mt-3">
              <ul className="flex justify-between">
                ...
                <li className="text-sm tracking-tight">
                  <label>{translate("মোট ছাড়: ", "Total Discount: ")}</label>
                  <b className="lg:font-[500] font-normal font-anek">
                    {translate(
                      convertToBnDigit(
                        formatter({
