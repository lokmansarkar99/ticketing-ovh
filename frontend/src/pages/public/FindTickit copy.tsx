    ...
    <section className="min-h-screen bg-cover bg-center bg-no-repeat">
      <PageWrapper>
        <div className="flex flex-col justify-center items-center">
          <PageTransition className="p-2 lg:p-5 w-full lg:w-8/12 border-primary/50 border-dashed backdrop-blur-[2px] duration-300">
            <div
                    ...
                    <div className="flex flex-col space-y-6">
                      ...
                      <div>
                        <div className="flex justify-center">
                          <div className="flex rounded-2xl overflow-hidden w-full lg:w-[850px]">
                            {/* Left Part */}
                            <div className="w-full lg:w-2/3 bg-[#f4a3ff] border-r-2 border-dashed border-b-2 border-l-2 border-gray-300 rounded-tr-2xl rounded-br-2xl overflow-hidden">
                              {/* Blue Header */}
                              <div className="bg-gradient-to-r from-sky-400 to-sky-600 text-white px-2 lg:px-6 py-3 flex justify-between items-center">
                              ...
                              <div className="flex justify-between">
                                <div className="px-2 lg:px-6 py-4 space-y-2 text-[10px] lg:text-sm text-gray-800">
                                  <p>
                                ...
                                {/* Route Box */}
                                <div className="hidden lg:block text-xs lg:text-base">
                                  <div className="text-sky-800 text-center font-semibold px-1 lg:px-3 py-2 rounded-md shadow-inner">
                                ...
                                <div className="hidden lg:block pr-3 mt-3 space-y-1">
                                  <div className="text-sky-600 ">
                                    <img
                                      src={iconicBusImg}
                                      alt="iconicBusImg"
                                      className="w-14 h-12 lg:w-24 lg:h-24 border rounded-md"
                                    />
                                  </div>

                                  <QRCode
                                    value={JSON.stringify(qrMinimalData)}
                                    className="bg-white p-[1px] w-[40px] h-[40px] md:w-[96px] md:h-[96px]"
                                  />
                                </div>
                                <div className="block lg:hidden">
                                  {/* QR Code + Bus icon placeholder */}
                                  <div className="pr-3 mt-3 space-y-1">
                                    <div className="text-sky-600 ">
                                      <img
                                        src={iconicBusImg}
                                        alt="iconicBusImg"
                            ...
                            {/* Right Part */}
                            <div className=" lg:w-1/3 bg-[#f4a3ff] rounded-tl-2xl rounded-bl-2xl border-b border-r overflow-hidden">
                              {/* Blue Header */}
