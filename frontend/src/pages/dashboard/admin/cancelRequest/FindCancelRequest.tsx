...
const FindCancelRequest: FC<ICounterFindTicketProps> = () => {
  ...
  return (
    <section className="min-h-screen bg-cover bg-center bg-no-repeat max-w-7xl mx-auto">
      <PageWrapper>
                      ...
                      <div className="flex justify-between">
                        ...
                        >
                          ...
                          <div className="space-y-1 text-sm">
                            ...
                            <div className="flex gap-2">
                              <p>
                                <strong>Journey Dt:</strong> {ticketData?.date}
                              </p>
                              <p>
...
export default FindCancelRequest;
