...
import { useGetSingleUserStatisticQuery, useUpdateUserStatisticMutation } from "@/store/api/statistics/statisticsApi";

interface ICoreValueProps {
  id: number | null;
}

const UpdateStatistics: FC<ICoreValueProps> = ({ id }) => {
  ...
  const { data: singleCoreValue, isLoading: coreValueLoading } =
    useGetSingleUserStatisticQuery(id);
  ...
  return (
    <FormWrapper
      heading={translate("কোর ভ্যালু হালনাগাত করুন", "Update Statistics")}
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <Submit
          ...
          errors={updateError}
          submitTitle={translate("কোর ভ্যালু হালনাগাত করুন", "Update Statistics")}
