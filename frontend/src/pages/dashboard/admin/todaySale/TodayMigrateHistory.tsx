...
const TodayMigrateHistory: FC<salesDataProps> = ({ salesData }) => {
  const totalItems = salesData?.todayMigrateHistory?.length || 0;
    ...
    <div>
      ...
      >
        ...
        <DataTable
          ...
          pagination
          columns={columns}
          data={salesData?.todayMigrateHistory || []}
        />
      </TableWrapper>
    </div>
  );
...
export default TodayMigrateHistory;
