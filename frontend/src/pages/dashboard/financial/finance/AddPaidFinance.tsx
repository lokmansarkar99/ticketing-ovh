...
interface IAddPaidFinanceProps {}

const AddPaidFinance: FC<IAddPaidFinanceProps> = () => {
  const { translate } = useCustomTranslator();

  return (
    <FormWrapper
      className="grid grid-cols-2 gap-x-4 gap-y-2"
      heading={translate("পেইড ফাইন্যান্স যোগ করুন", "Add Paid Finance")}
      subHeading={translate(
        "সিস্টেমে নতুন পেইড ফাইন্যান্স যোগ করতে নিচের বিস্তারিত পূরণ করুন।",
        "Fill out the details below to add a new paid finance to the system."
      )}
    >
      <InputWrapper
        label={translate(
