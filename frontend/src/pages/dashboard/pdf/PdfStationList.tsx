...
const PdfStationList: React.FC<PdfSeatStatusReportProps> = ({ result, singleCms }) => {
        ...
        <Document>
            <Page size="A4" style={styles.page}>
                <View style={styles.section}>
                    ...
                    <Text style={styles.title}>Station List</Text>

                    <View style={styles.table}>
                        <View style={styles.tableRow}>
                            <View style={styles.tableHeader}><Text>SN</Text></View>
                            <View style={styles.tableHeader}><Text>Station Name</Text></View>
                        ...
                        {result?.map((sale: any, index: number) => (
                            <View style={styles.tableRow} key={sale.id}>
                                ...
                                <View style={styles.tableCol}><Text>{sale?.isActive ? "Active" : "Deactive"}</Text></View>
                            </View>
                        ))}
                    </View>
                </View>
