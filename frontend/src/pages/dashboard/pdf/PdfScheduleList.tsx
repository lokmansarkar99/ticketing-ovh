...
const PdfScheduleList: React.FC<PdfSeatStatusReportProps> = ({ result, singleCms }) => {
                    ...
                    <View style={styles.table}>
                        ...
                        {result?.map((sale: any, index: number) => (
                            <View style={styles.tableRow} key={sale.id}>
                                ...
                                <View style={styles.tableCol}><Text>{sale?.time}</Text></View>
                            </View>
                        ))}
                    </View>
                </View>
...
export default PdfScheduleList;
