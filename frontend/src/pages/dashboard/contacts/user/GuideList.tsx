...
const GuideList: FC<IUserListProps> = () => {
  ...
  const { data: usersData, isLoading: userLoading } = useGetGuidesQuery({
    ...
    <PageWrapper>
      <TableWrapper
        subHeading={translate(
          ...
          "Guide list and all ralevnet information & data"
        )}
        heading={translate("ব্যবহারকারী", "Guide List")}
      >
                ...
                <DialogTrigger asChild>
                  ...
                  >
                    ...
                    <span className="custom-tooltip-top">
                      {translate("ব্যবহারকারী যুক্ত করুন", "Add Guide")}
                    </span>
                  </Button>
                </DialogTrigger>
                <DialogContent size="lg">
                  <DialogTitle className="sr-only">empty</DialogTitle>
                  <AddGuide setUserState={setUserState} />
                </DialogContent>
              </Dialog>
            </li>
            <li>
