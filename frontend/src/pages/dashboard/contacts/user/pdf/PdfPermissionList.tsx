...
const PdfPermissionList = ({ result, singleCms }: any) => {
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.table}>
                        <View style={styles.tableRow}>
                            ...
                            <View style={styles.tableHeader}><Text>Name</Text></View>
                            <View style={styles.tableHeader}><Text>Permission Type</Text></View>
                        </View>
                        ...
                        {result?.map((sale: any, index: number) => (
                            <View style={styles.tableRow} key={sale.id}>
                                ...
                                <View style={styles.tableCol}><Text>{sale?.permissionType?.name}</Text></View>
                            </View>
                        ))}
                    </View>
                </View>
...
export default PdfPermissionList;