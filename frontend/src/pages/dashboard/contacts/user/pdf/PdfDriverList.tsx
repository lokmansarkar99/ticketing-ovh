...
const PdfDriverList = ({ result, singleCms }: any) => {
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.table}>
                        <View style={styles.tableRow}>
                            ...
                            <View style={styles.tableHeader}><Text>License Url</Text></View>
                        ...
                        {result?.map((sale: any, index: number) => (
                            <View style={styles.tableRow} key={sale.id}>
                                ...
                                <View style={styles.tableCol}><Text>{sale?.licensePhoto}</Text></View>
