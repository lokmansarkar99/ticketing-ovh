...
const PdfUserList = ({ result, singleCms }: any) => {
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.table}>
                        <View style={styles.tableRow}>
                            ...
                            <View style={styles.tableHeader}><Text>Role</Text></View>
                        ...
                        {result?.map((sale: any, index: number) => (
                            <View style={styles.tableRow} key={sale.id}>
                                ...
                                <View style={styles.tableCol}><Text>{sale?.userName}</Text></View>
                                <View style={styles.tableCol}><Text>{sale?.contactNo}</Text></View>
                                <View style={styles.tableCol}><Text>{sale?.role?.name}</Text></View>
